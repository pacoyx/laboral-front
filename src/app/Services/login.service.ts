...
export class LoginService {
  ...
  private epValidaTokenLinkedin = environment.epValidaTokenLinkedin;
  ...
  validaTokenLinkedin(body: any) {
    return this.http.post<any>(this.epRaiz + this.epValidaTokenLinkedin, body);
  }
